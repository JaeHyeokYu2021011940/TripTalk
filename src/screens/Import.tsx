...
import { StyleSheet, View, Text, Image, TouchableOpacity, NativeModules, Alert, ScrollView } from "react-native";
  ...
  return (
    <View style={styles.import}>
      ...
      <View style={styles.content}>
        <TouchableOpacity style={[styles.button, styles.iconFlexBox]} onPress={pickFile}>
        ...
        <TouchableOpacity
          style={[styles.button2, styles.iconFlexBox, !kakaoText && styles.buttonDisabled]}
          disabled={!kakaoText}
          onPress={() => Alert.alert("분석 시작", "곧 타임라인 기능을 추가할게요!")}
        >
